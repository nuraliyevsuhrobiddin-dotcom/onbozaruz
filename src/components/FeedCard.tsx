      ...
      <div className="px-4 pt-3 pb-4 space-y-2.5">
        ...
        <div className="flex gap-2 pt-1">
          <motion.a
            ...
            className="flex-1 py-2.5 rounded-[16px] bg-[#D84315] hover:bg-[#D32F2F] text-white font-bold text-[13px] flex items-center justify-center gap-2 transition-colors shadow-md cursor-pointer"
          >
          ...
          {post.telegram && (
            <motion.a
              href={currentUser ? `https://t.me/${post.telegram.replace(/^@/, '').replace(/\s+/g, '')}` : undefined}
              ...
              className="w-10 h-10 rounded-[16px] bg-[#0088cc] hover:bg-[#0077bb] text-white flex items-center justify-center transition-colors shrink-0 shadow-sm cursor-pointer"
            >
